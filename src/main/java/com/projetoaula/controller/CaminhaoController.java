...
public class CaminhaoController {
    ...
    public ModelAndView excluir(@PathVariable Long id){
        ModelAndView modelAndView = new ModelAndView("redirect:/caminhao");
        servico.excluir(id);
        return modelAndView;
    }
    
    @GetMapping("/pesados")
    public String pesados(Model model){
        List<Caminhao> caminhao = servico.ListaCaminhoesPesados(2000);
        model.addAttribute("caminhoes", caminhao);
        return "caminhaoListar";
    }
}
